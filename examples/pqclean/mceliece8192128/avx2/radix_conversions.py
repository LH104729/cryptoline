...
invpoly = [ "z**11+z**10+z**9+z**8+z**7+z**6+z**5+z**4+z**3+z+1", # inverse of z**2 + z
            "z**12+z**11+z**8+z**5+z**3+z**2+z+1",                # inverse of z**4 + z
            "z**11+z**6+z**5+z**4+z**2+z",                        # inverse of z**8 + z
            "z**10+z**9+z**6+z**4+z**3",                          # inverse of z**16 + z
            "z**11+z**8+z**5+z**3+z**2+z+1",                      # inverse of z**32 + z
            "z**9+z**4+z" ]                                       # inverse of z**64 + z
